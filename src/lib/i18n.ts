...
const dict = {
  ...
  // Sprint 6 UI upgrades
  alertsCenter: { en: "Alerts Center", pt: "Central de Alertas" },
  alertsCenterDesc: { en: "Mocked alerts for prices and portfolio risk", pt: "Alertas simulados para preços e risco do portfólio" },
  priceMoveAlerts: { en: "Price Move Alerts", pt: "Alertas de Movimento de Preço" },
  riskAlertsList: { en: "Risk Alerts", pt: "Alertas de Risco" },
  alertAbove: { en: "crossed above", pt: "ultrapassou" },
  alertBelow: { en: "dropped below", pt: "caiu abaixo de" },
  concentrationAlert: { en: "concentration above recommended limit", pt: "concentração acima do limite recomendado" },
  createMockAlert: { en: "Create Mock Alert", pt: "Criar Alerta Simulado" },
  alertCreated: { en: "Mock alert added", pt: "Alerta simulado adicionado" },
  justNow: { en: "just now", pt: "agora" },
  minutesAgo: { en: "min ago", pt: "min atrás" },
  hoursAgo: { en: "h ago", pt: "h atrás" },
  thresholdUp: { en: "Above", pt: "Acima" },
  thresholdDown: { en: "Below", pt: "Abaixo" },
  percentMove: { en: "% move", pt: "variação %" },
  enabled: { en: "Enabled", pt: "Ativo" },
  disabled: { en: "Disabled", pt: "Desativado" },
  portfolioRiskHigh: { en: "Portfolio concentration above target", pt: "Concentração do portfólio acima da meta" },
  exposureWarning: { en: "High exposure in top 2 assets", pt: "Alta exposição nos 2 principais ativos" },
  volatilityWarning: { en: "24h volatility spike detected", pt: "Pico de volatilidade em 24h detectado" },
  savePreset: { en: "Save preset", pt: "Salvar preset" },
  savedPresets: { en: "Saved presets", pt: "Presets salvos" },
  presetName: { en: "Preset name", pt: "Nome do preset" },
  applyPreset: { en: "Apply", pt: "Aplicar" },
  deletePreset: { en: "Delete", pt: "Excluir" },
  noPresetsYet: { en: "No presets saved yet", pt: "Nenhum preset salvo ainda" },
  density: { en: "Density", pt: "Densidade" },
  compact: { en: "Compact", pt: "Compacta" },
  comfortable: { en: "Comfortable", pt: "Confortável" },
  onboardingTitle: { en: "Quick tour", pt: "Tour rápido" },
  onboardingDismiss: { en: "Got it", pt: "Entendi" },
  onboardingDashboardTip: { en: "Use Alerts Center to track threshold moves and portfolio risks.", pt: "Use a Central de Alertas para acompanhar movimentos de preço e riscos do portfólio." },
  onboardingProposalsTip: { en: "Save your filter setup as presets for faster review sessions.", pt: "Salve sua configuração de filtros como presets para revisões mais rápidas." },
  onboardingOpportunitiesTip: { en: "Combine chain, source and age filters, then save as a reusable preset.", pt: "Combine filtros de rede, fonte e idade, e salve como preset reutilizável." },
  filtersAndSort: { en: "Filters & Sort", pt: "Filtros e Ordenação" },
} as const;
